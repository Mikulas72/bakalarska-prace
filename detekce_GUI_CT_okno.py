...
def dotaz_ct_okno_vlastni(pocet_spusteni):
    ...
    dotaz_vlastni_ct_okno.geometry("510x150")
    odsazeni = 5
    sticky_parametr_sloupec = "ew"
    var = tk.StringVar()
    var.set("A")
    ...
    tlacitko_spustit_A.grid(row=5, column=0, columnspan=2, sticky=sticky_parametr_sloupec, padx=odsazeni, pady=odsazeni)
    ...
    tlacitko_spustit_B.grid(row=5, column=3, columnspan=2, sticky=sticky_parametr_sloupec, padx=odsazeni, pady=odsazeni)
    ...
    tlacitko_smazat.grid(row=5, column=2, sticky=sticky_parametr_sloupec, padx=odsazeni, pady=odsazeni)
